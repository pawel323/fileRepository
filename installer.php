...
<h5 style="text-align:center">Podaj informacje dotyczące bazy danych</h5>
<form method="POST" action="instalacjaDB.php">
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <label for="user">Użytkownik bazy danych</label>
  ...
  <div class="mb-3">
    ...
    <label for="pass">Hasło dostępu do bazy danych</label>
  ...
  <button type="submit" class="btn btn-secondary">Zainstaluj</button>
  <?php
